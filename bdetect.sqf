...
if(isNil "bdetect_fps_calc_each_x_frames") then { bdetect_fps_calc_each_x_frames = 15; }; 						// (Number, Default 15) FPS check is done each "bdetect_fps_min" frames. 1 means each frame.
